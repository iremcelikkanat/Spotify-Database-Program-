...
public class kullaniciGiris extends JFrame {
	...
	Object[] kolonlar= {"isim","dinelenmesays"};
	...
	Object[] kolonlar3= {"isim","dinelenmesays"};
	Object[] satirlar3= new Object[2];
	Object[] kolonlarpop= {"Pop","dinelenme"};
	Object[] satirlarpop= new Object[2];
	Object[] kolonlarcaz= {"Caz","dinelenme"};
	Object[] satirlarcaz= new Object[10];
	Object[] kolonlarklasik= {"Klasik","dinelenme"};
	...
	public kullaniciGiris() {
		...
		labelCaz.setIcon(new ImageIcon("C:\\Users\\kanat\\Desktop\\Ba\u015Fl\u0131ks\u0131z-3.png"));
		...
		scrollPanePop.setViewportView(tablepop);
		 ...
		 sql_sorgu="select sarki_adi,dinelenmesayisi from sarki where turID='1' and sarki_id in(select sarkilarID from kullanicidinlenensarkilar where kullanicilarID="+o.k_id+")";
		System.out.println(sql_sorgu);
		res=baglanti.arama(sql_sorgu);

	try {
		while(res.next()) {
			satirlarpop[0]= res.getString("sarki_adi");
			satirlarpop[1]= res.getInt("dinelenmesayisi");
		...
		sql_sorgu="select sarki_adi,dinelenmesayisi from sarki where turID='2' and sarki_id in(select sarkilarID from kullanicidinlenensarkilar where kullanicilarID="+o.k_id+")";
		System.out.println(sql_sorgu);
		res=baglanti.arama(sql_sorgu);
	
	try {
		while(res.next()) {
			satirlarcaz[0]= res.getString("sarki_adi");
			satirlarcaz[1]= res.getInt("dinelenmesayisi");
		...
		sql_sorgu="select sarki_adi,dinelenmesayisi from sarki where turID='3' and sarki_id in(select sarkilarID from kullanicidinlenensarkilar where kullanicilarID="+o.k_id+")";
		System.out.println(sql_sorgu);
		res=baglanti.arama(sql_sorgu);
		
	try {
		while(res.next()) {
			satirlarklasik[0]= res.getString("sarki_adi");
			satirlarklasik[1]= res.getInt("dinelenmesayisi");
	...
	tableklasik.setModel(modelimKlasik);
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					e2.printStackTrace();
			    	 ...
			    	 res=baglanti.yap("kullanicidinlenensarkilar");
			    	 String sql_sorgu="select sarki_adi,dinelenmesayisi from sarki where turID='2' and sarki_id in(select sarkilarID from kullanicidinlenensarkilar where kullanicilarID="+o.k_id+")";
			 		res=baglanti.arama(sql_sorgu);
			 	...
			 	try {
			    	 ...
			    	 res=baglanti.yap("kullanicidinlenensarkilar");
			    	 String sql_sorgu="select sarki_adi,dinelenmesayisi from sarki where turID='3' and sarki_id in(select sarkilarID from kullanicidinlenensarkilar where kullanicilarID="+o.k_id+")";
			 		 res=baglanti.arama(sql_sorgu);
		...
		btnAra.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(secilen==0) {
					sqlsorgu="select sarki_adi,dinelenmeSayisi from sarki where turID=1 order by dinelenmeSayisi DESC";
				}else if(secilen==1) {
					sqlsorgu="select sarki_adi,dinelenmeSayisi from sarki where turID=2 order by dinelenmeSayisi DESC";
				}else if(secilen==2) {
					sqlsorgu="select sarki_adi,dinelenmeSayisi from sarki where turID=3 order by dinelenmeSayisi DESC";
				}else if(secilen==3) {
					sqlsorgu="select sarki_adi,dinelenmeSayisi from sarki order by dinelenmeSayisi DESC";
				}
				...
				try {
					...
					while(myRs.next()) {
						satirlar[0]= myRs.getString("sarki_adi");
						satirlar[1]= myRs.getString("dinelenmeSayisi");
		...
		String sqlsorgu="select kullanici_adi,kullanici_id from kullanici where kullanici_id in(select takipedilen_ID from takipedilenkullanici where kullaniciID="+o.k_id+")";
		...
		ulkeSira.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(secilen==0) {
					sqlsorgu="select sarki_adi,dinelenmeSayisi from sarki where sarki_id in(select sarkilarID from kullanicidinlenensarkilar where kullanicilarID in("
							+"select kullanici_id from kullanici where ulkeID=1)) order by dinelenmeSayisi DESC";
				}else if(secilen==1) {
					sqlsorgu="select sarki_adi,dinelenmeSayisi from sarki where sarki_id in(select sarkilarID from kullanicidinlenensarkilar where kullanicilarID in("
							+"select kullanici_id from kullanici where ulkeID=2)) order by dinelenmeSayisi DESC";				
				}else if(secilen==2) {
					sqlsorgu="select sarki_adi,dinelenmeSayisi from sarki where sarki_id in(select sarkilarID from kullanicidinlenensarkilar where kullanicilarID in("
							+"select kullanici_id from kullanici where ulkeID=5)) order by dinelenmeSayisi DESC";
				}
				System.out.println(sqlsorgu);
				myRs=baglanti.arama(sqlsorgu);
				try {
					...
					while(myRs.next()) {
						satirlar3[0]= myRs.getString("sarki_adi");
						satirlar3[1]= myRs.getString("dinelenmeSayisi");
		...
		lblNewLabel_2.setIcon(new ImageIcon("C:\\Users\\kanat\\Desktop\\Ba\u015Fl\u0131ks\u0131z-3.png"));
		lblNewLabel_2.setBounds(475, 474, 330, 155);
		contentPane.add(lblNewLabel_2);
		
		
		JLabel lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\kanat\\Desktop\\Ba\u015Fl\u0131ks\u0131z-3.png"));
