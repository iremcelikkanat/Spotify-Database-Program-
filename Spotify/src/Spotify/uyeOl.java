...
public class uyeOl extends JFrame {
	...
	public uyeOl() {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"T\u00FCrkiye i\u00E7in 1 giriniz.", "\u0130ngiltere i\u00E7in 2 giriniz.", "Rusya i\u00E7in 3 giriniz.", "Fransa i\u00E7in 4 giriniz.", "Almanya i\u00E7in 5 giriniz."}));
